...
ast::event_precondition_list action_preconditions_parser::parse(epddl::parser_helper &helper) {
...
ast::event_precondition action_preconditions_parser::parse_event_precondition(epddl::parser_helper &helper) {
